<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="bsuPizza.Order" %>
...
<body class="has-drawer container">
    <header class="container">
      <nav class="collapse navbar-collapse navbar-inverse"> <!-- Menu bar-->
          ...
          <ul class="nav navbar-nav">
                ...
                <li> <a href="ZoomPage.aspx">Zoom Pizza Picture</a>  </li>
            </ul>
        </nav><!-- Close Menu bar-->
    </header>
    ...
    <div class="container"> <!-- Start container-->
      <div class="row">  <!-- Start row -->
        ...
        <asp:Image ID="ImageSteak" runat="server" ImageUrl="~/images/Steak.png" CssClass="Steak" Visible="False" />
            ...
            <div class="col-md-6"> <!-- Pizza order infor-->
     <form runat="server" class="form-horizontal" id="FormOrder"><!--Start form-->
        ...
        <asp:DropDownList ID="DropDownListPizzaSize" runat="server" class="form-control" AutoPostBack="True" >
            ...
            <asp:ListItem Value="8">Extra Large</asp:ListItem>
              ...
              </div><!-- Close Pizza size group-->
           <div class="form-group"><!-- Pizza style group-->
        ...
        <asp:DropDownList ID="DropDownListPizzaStyle" runat="server" class="form-control">
            ...
            <asp:ListItem Value="Deep_Dish">Deep Dish</asp:ListItem>
            <asp:ListItem Value="Tomato_Pie">Tomato Pie</asp:ListItem>
            <asp:ListItem Value="Stuffed_Crust">Stuffed Crust</asp:ListItem>
        </asp:DropDownList>
             </div>
                 </div><!-- Close Pizza style group-->
         <!-- Pizza toppings-->
